...
//  // Load model
//  const tflite::Model* model =
//	      tflite::GetModel(model_full_integer_quant_128x160_tflite);
...
TfLiteStatus RunFastDepth() {
  ...
  xil_printf("Input dims: %d x %d x %d\n",
              input->dims->data[1],
              input->dims->data[2],
              input->dims->data[3]);

  xil_printf("Output dims: %d x %d x %d\n",
              output->dims->data[1],
              output->dims->data[2],
              output->dims->data[3]);
