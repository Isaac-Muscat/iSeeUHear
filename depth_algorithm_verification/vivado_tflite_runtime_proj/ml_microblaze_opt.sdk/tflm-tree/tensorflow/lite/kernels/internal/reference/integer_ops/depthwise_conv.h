...
inline void DepthwiseConvPerChannel(
    ...
    int8_t* output_data) {
    xil_printf("DepthwiseConvPerChannel Started:\n");
  // Get parameters.
  ...
  xil_printf("input_offset %d \n\t\tstride_width %d \n\t\tstride_height %d \n\t\tdilation_width_factor %d \n\t\tdilation_height_factor %d \n\t\tdepth_multiplier %d\n\t\t",
		      input_offset, 	stride_width, 	 stride_height,    dilation_width_factor,    dilation_height_factor, depth_multiplier);
  ...
  xil_printf("input_width %d \n\t\tfilter_height %d \n\t\tfilter_width %d \n\t\toutput_height %d \n\t\toutput_width %d\n",
			   input_width, 	filter_height, 	 filter_width, output_height, 	 output_width);
