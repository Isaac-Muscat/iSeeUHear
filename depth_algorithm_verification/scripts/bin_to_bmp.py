...
#INPUT_BIN = "/mnt/c/Users/isaac/Downloads/temp.bin"
INPUT_BIN = "/mnt/c/Users/isaac/Downloads/right.bin"
#INPUT_COE = "data_coe_80x60_nearest_grayscale/artroom1/im0.coe"
OUTPUT_BMP = "output_bin.bmp"

# WIDTH = ORIG_WIDTH - MAX_DISPARITY - BLOCKSIZE
# HEIGHT = ORIG_HEIGHT - BLOCKSIZE + 1
IMAGE_WIDTH =  160    # <-- set this
IMAGE_HEIGHT = 120    # <-- set this
#IMAGE_WIDTH =  136    # <-- set this
#IMAGE_HEIGHT = 113    # <-- set this
#IMAGE_WIDTH =  640    # <-- set this
#IMAGE_HEIGHT = 480    # <-- set this
...
if __name__ == "__main__":
    parser = argparse.ArgumentParser(description='Depth converter')
    ...
    with open(args.input, "rb") as f:
        lines = f.read()
        img_array = list(lines)
        print(img_array)

        img = Image.new("L", (width, height))
        img.putdata(img_array[:width * height])
