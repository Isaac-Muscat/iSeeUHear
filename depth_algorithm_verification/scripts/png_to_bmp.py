...
OUTPUT_FOLDER = "data_bmp_80x60_nearest"      # output root folder
...
def save_bmp(filename, image, scale=1.0):
    """
...
def convert_png_to_bmp(input_root, output_root):
    ...
    for root, dirs, files in os.walk(input_root):
        for file in files:
            if file.lower().endswith(".png"):
                ...
                resized_image = img.resize((80,60), Image.Resampling.NEAREST)
